...
4. eine Regelung bezüglich der Verwendung der Rückstellungen gemäß <<_85_übertragung_von_befugnissen_der_kassenverwaltung, § 85 Absatz 8>>, der bereits zugewiesenen Finanzmittel und der Verwendung der Ausstattung derjenigen bestehenden Fachschaften, die von der Neugliederung betroffen sind.
...
9. über den Verteilungsschlüssel bezüglich der Verteilung der Zuweisungen an die Fachschaften gemäß <<_78_feststellung_und_in_kraft_treten_des_haushaltsplans, § 78 Absatz 3>> zu beschließen;
